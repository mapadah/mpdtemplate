    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                text.text = PluginInfo.Name + " <color=black>[</color><color=white>" + (pageNumber + 1).ToString() + "</color><color=black>]</color>";
                text.fontSize = 1;
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        disconnectbutton.AddComponent<Classes.Button>().relatedText = "bye bye!";
                ...
                // Page Buttons
                    ...
                    gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.2f);
                    gameObject.transform.localPosition = new Vector3(0.45f, 0.45f, 0);
                    ...
                    component.localPosition = new Vector3(0.07f, 0.13f, 0f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                    ...
                    component.localPosition = Vector3.zero;
                    component.sizeDelta = new Vector2(0.2f, 0.03f);
                    component.localPosition = new Vector3(0.064f, -0.13f, 0f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            RectTransform component = text.GetComponent<RectTransform>();
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(.06f, .03f);
